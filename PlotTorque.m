function fig=PlotTorque(in_ps, in_mm)
    fig=figure;
...
%         Te(i)=2.5*31*0.0248*iq(i);
    ...
    plot(ax,in_mm.Data.(in_mm.DataName{1})([in_ps.Current.StartPoint:1:in_ps.Current.EndPoint],1), ...
            iq([in_ps.Current.StartPoint:1:in_ps.Current.EndPoint]), ...
...
% ripple1=std(MotorTorque((Start_Point:1:End_Point),:))/mean(MotorTorque((Start_Point:1:End_Point),:))*100;
...
% yline(ax,7.5,'-.b','LineWidth',1.5,'Color',in_ps.TorqueFigParams.Color(2));
...
annotation(fig,'textbox',...
    ...
    'FontName','Times New Roman',...
    'EdgeColor','none');
leg1=legend(ax,'\boldmath{$i_q$}','\boldmath{$i_d$}',...
        'Interpreter','latex', ...
        'Location','best', ...
        'AutoUpdate','off', ...
        'FontName','Times New Roman', ...
